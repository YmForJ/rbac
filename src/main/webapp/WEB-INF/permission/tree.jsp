...
<html lang="zh-CN">
  ...
  <body>
	...
	<script src="${base }/ztree/js/jquery.ztree.all-3.5.min.js"></script>
	<script src="${base }/layer/layer.js"></script>
        <script type="text/javascript">
				...
				data:{
					...
					view: {
                        ...
                        //   <a><span></span></a>
							...
							if ( treeNode.level == 0 ) {
								s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;" onclick="addPermission('+treeNode.pid+')" href="#" >&nbsp;&nbsp; <i class="fa fa-fw fa-plus rbg ">增加</i></a>';
							} else if ( treeNode.level == 1 ) {
								s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;"  href="#" onclick="updatePermission('+treeNode.pid+')" title="修改权限信息">&nbsp;&nbsp;<i class="fa fa-fw fa-edit rbg ">修改</i></a>';
								if (treeNode.children.length == 0) {
									s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;" onclick="deletePermission('+treeNode.pid+')" href="#" >&nbsp;&nbsp;<i class="fa fa-fw fa-times rbg ">删除</i></a>';
								}
								s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;" onclick="addPermission('+treeNode.pid+')" href="#" >&nbsp;&nbsp;<i class="fa fa-fw fa-plus rbg ">增加</i></a>';
							} else if ( treeNode.level == 2 ) {
								s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;"  href="#" title="修改权限信息" onclick="updatePermission('+treeNode.pid+')">&nbsp;&nbsp;<i class="fa fa-fw fa-edit rbg ">修改</i></a>';
								s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;" href="#" onclick="deletePermission('+treeNode.pid+')">&nbsp;&nbsp;<i class="fa fa-fw fa-times rbg ">删除</i></a>';
							}
            ...
            function deletePermission(no){
            	$.ajax({
            		url:"${base}/permission/deleteDo",
            		type:"post",
            		data:{"pid":no},
            		success:function(res){
            			if(res.result){
            				layer.msg("删除成功",{time:1500,icon:6},function(){
            					location.reload();
            				})
            			}
            		}
            ...
            function addPermission(no){
            	window.location.href="${base}/permission/initAdd?pid="+no;	
            }
            
            function updatePermission(no){
            	window.location.href="${base}/permission/initUpdate?pid="+no;	
            }
        </script>
  </body>
</html>
